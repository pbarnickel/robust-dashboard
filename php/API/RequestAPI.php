...
class RequestAPI extends BaseAPI
{
    ...
    public static function getRbsTotalSupply()
    {
        $oCurl = curl_init();

        curl_setopt($oCurl, CURLOPT_URL, Constants::API_RBS_TOTAL_SUPPLY);
        curl_setopt($oCurl, CURLOPT_RETURNTRANSFER, 1);
    ...
    public static function getRbsMarketCap()
    {
        $oCurl = curl_init();

        curl_setopt($oCurl, CURLOPT_URL, Constants::API_RBS_MARKETCAP);
        curl_setopt($oCurl, CURLOPT_RETURNTRANSFER, 1);
    ...
    public static function getRbsHolders()
    {
        $oCurl = curl_init();

        curl_setopt($oCurl, CURLOPT_URL, Constants::API_RBS_HOLDERS);
        curl_setopt($oCurl, CURLOPT_RETURNTRANSFER, 1);
